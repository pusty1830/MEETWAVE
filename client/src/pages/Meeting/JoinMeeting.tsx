...
import { joinMeetingSchema } from '../../components/Schema';
import color from '../../components/utils/Colors';
import { getUserId, getUserName, isLoggedIn } from '../../services/axiosClient';
import InfoIcon from '@mui/icons-material/Info';
import { createMeeting } from '../../services/Services';
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            createMeeting(payLoad).then((res) => {
                navigate(`/room/${values.meetingId}`, { state: { meetingId: values.meetingId, userName: values.userName } })
            }).catch((err) => {
                console.log(err);
            })
        },
